...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3092068161ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=emp_db&table=emp_dept">`emp_db`.`emp_dept`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=emp_db&table=emp_dept_map">`emp_db`.`emp_dept_map`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=emp_db&table=EMP_DEPT_MAP">`emp_db`.`EMP_DEPT_MAP`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=emp_db&table=EMP_DEPT">`emp_db`.`EMP_DEPT`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=emp_db&table=emp_country">`emp_db`.`emp_country`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=emp_db&table=EMP_COUNTRY">`emp_db`.`EMP_COUNTRY`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=school_info&table=student">`school_info`.`student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=school_info&table=course">`school_info`.`course`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=school_info&table=st_co">`school_info`.`st_co`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=school_info&table=St_Co">`school_info`.`St_Co`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="595f4764443d334c4e6a262c62456b4a">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="school_info" targettable="student">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `school_info`.`student` ( `St_ID` INT(5) NOT NULL ,    PRIMARY KEY  (`St_ID`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="school_info" targettable="student">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `school_info`.`student` ( `St_ID` INT(5) NOT NULL ,  `St_Name` VARCHAR(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,  `Phone_No` INT(10) NOT NULL ,  `Address` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="school_info" targettable="student">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `school_info`.`student` ( `St_ID` INT(5) NOT NULL ,  `St_Name` VARCHAR(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,  `Phone_No` INT(10) NOT NULL ,  `Address` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ) ENGINE = InnoDB;</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="school_info" targettable="course">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `school_info`.`course` ( `Co_ID` INT(5) NOT NULL ,  `Co_Name` VARCHAR(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,  `Lec_ID` INT(5) NOT NULL ,    PRIMARY KEY  (`Co_ID`, `Lec_ID`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="school_info" targettable="lecture">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `school_info`.`lecture` ( `Lec_ID` INT(5) NULL ,  `Lec_Name` VARCHAR(20) NULL ,    PRIMARY KEY  (`Lec_ID`)) ENGINE = InnoDB;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `lecture`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="school_info" targettable="student">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `course`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="school_info" targettable="st_co">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `school_info`.`st_co` ( `St_ID` INT(5) NOT NULL ,  `Co_ID` INT(5) NOT NULL ,    PRIMARY KEY  (`St_ID`, `Co_ID`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="school_info" targettable="student">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `student`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="emp_db" targettable="emp_country">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `emp_db`.`emp_country` ( `EMP_ID` INT(5) NOT NULL ,  `EMP_Country` VARCHAR(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,    PRIMARY KEY  (`EMP_ID`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="emp_db" targettable="emp_dept">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `emp_db`.`emp_dept` ( `EMP_DEPT` VARCHAR(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,  `DEPT_TYPE` VARCHAR(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,  `EMP_DEPT_NO` INT(10) NOT NULL ,    PRIMARY KEY  (`EMP_DEPT`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="emp_db" targettable="emp_dept_map">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `emp_db`.`emp_dept_map` ( `EMP_ID` INT(5) NOT NULL ,  `EMP_DEPT` VARCHAR(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,    PRIMARY KEY  (`EMP_ID`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="emp_db" targettable="emp_dept_map">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `emp_dept_map`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="emp_db" targettable="emp_dept_map">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `emp_dept_map` DROP PRIMARY KEY, ADD PRIMARY KEY(`EMP_DEPT`);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="emp_db" targettable="emp_dept_map">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `emp_dept_map` DROP PRIMARY KEY, ADD PRIMARY KEY(`EMP_ID`, `EMP_DEPT`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="emp_db" targettable="emp_dept">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `emp_dept`</span>
                        </div>
